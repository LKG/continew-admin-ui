  ...
  <a-spin :loading="loading">
    ...
    >
      ...
      <a-form-item class="input-item" field="SITE_TITLE" :label="siteConfig.SITE_TITLE.name" :help="siteConfig.SITE_TITLE.description">
        <a-input v-model.trim="form.SITE_TITLE" placeholder="请输入站点名称" :max-length="18" show-word-limit />
      </a-form-item>
...
const rules: FormInstance['rules'] = {
  SITE_TITLE: [{ required: true, message: '请输入站点名称' }],
  SITE_DESCRIPTION: [{ required: true, message: '请输入站点描述' }],
